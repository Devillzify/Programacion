...
public class Ordenada<current>
{
    ...
    { // creamos nodo y si first es igual a nada, no hay nadie y el que insertamos a la vez es el primero y el ultimo, si no hay que recorrer la lista hasta que haya sitio
